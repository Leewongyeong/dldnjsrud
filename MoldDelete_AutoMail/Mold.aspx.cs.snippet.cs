//==========================================================================================
//  Mold.aspx.cs  (Data_modify.Mold)  - "추가할 부분"만 정리한 파일입니다.
//  기존 Mold.aspx.cs 를 그대로 두고, 아래 내용만 클래스 안에 붙여넣으세요.
//
//  대상 DB   : SCKCIMDWH.WORLD  (web.config connectionStrings name : rtsConnectionString)
...
{
    public partial class Mold : System.Web.UI.Page
    {
        ...
        /// Mold.aspx 의 GridView1 태그에 OnRowDeleted="GridView1_RowDeleted" 를 추가해야 동작한다.
        /// </summary>
