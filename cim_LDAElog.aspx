                                            ...
                                            <table class="table table-lotInfo use-head" id="tb_material_information_qa" runat="server">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><asp:TextBox ID="txt_sys1_information_qa_h2" runat="server" class="form-control" placeholder="자동생성" ReadOnly="True" /></td>
                                                        <td><asp:TextBox ID="txt_sys2_information_qa" runat="server" class="form-control" placeholder="자동생성" ReadOnly="True" /></td>
                                                        <td><asp:TextBox ID="txt_sys2_information_qa_h2" runat="server" class="form-control" placeholder="자동생성" ReadOnly="True" /></td>
                                                        <td><asp:TextBox ID="txt_sys3_information_qa" runat="server" class="form-control" placeholder="자동생성" ReadOnly="True" /></td>
                                                        <td><asp:TextBox ID="txt_sys3_information_qa_h2" runat="server" class="form-control" placeholder="자동생성" ReadOnly="True" /></td>
                                                        <td><asp:TextBox ID="txt_sys4_information_qa" runat="server" class="form-control" placeholder="자동생성" ReadOnly="True" /></td>
                                                        <td><asp:TextBox ID="txt_sys4_information_qa_h2" runat="server" class="form-control" placeholder="자동생성" ReadOnly="True" /></td>
                                                        <td><asp:TextBox ID="txt_lid_information_qa" runat="server" class="form-control" placeholder="자동생성" ReadOnly="True" /></td>
                                                        <td><asp:TextBox ID="txt_lid_information_qa_h2" runat="server" class="form-control" placeholder="자동생성" ReadOnly="True" /></td>
                                                    </tr>
                                                    <tr>
                                                        <th>Batch No</th>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txt_sys1_batch_no_qa_h2" runat="server" class="form-control" Style="width:65%;display:inline-block;text-transform:uppercase;" AutoPostBack="True" OnTextChanged="txt_sys1_batch_no_qa_h2_TextChanged" />
                                                            <asp:Button class="btn btn-add btn-xs btn-inverse" ID="btn_sys1_na_qa_h2" runat="server" Width="30%" Text="N/A" OnClick="btn_sys1_na_qa_h2_Click" />
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txt_sys2_batch_no_qa_h2" runat="server" class="form-control" Style="width:65%;display:inline-block;text-transform:uppercase;" AutoPostBack="True" OnTextChanged="txt_sys2_batch_no_qa_h2_TextChanged" />
                                                            <asp:Button class="btn btn-add btn-xs btn-inverse" ID="btn_sys2_na_qa_h2" runat="server" Width="30%" Text="N/A" OnClick="btn_sys2_na_qa_h2_Click" />
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txt_sys3_batch_no_qa_h2" runat="server" class="form-control" Style="width:65%;display:inline-block;text-transform:uppercase;" AutoPostBack="True" OnTextChanged="txt_sys3_batch_no_qa_h2_TextChanged" />
                                                            <asp:Button class="btn btn-add btn-xs btn-inverse" ID="btn_sys3_na_qa_h2" runat="server" Width="30%" Text="N/A" OnClick="btn_sys3_na_qa_h2_Click" />
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txt_sys4_batch_no_qa_h2" runat="server" class="form-control" Style="width:65%;display:inline-block;text-transform:uppercase;" AutoPostBack="True" OnTextChanged="txt_sys4_batch_no_qa_h2_TextChanged" />
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><asp:TextBox ID="txt_sys1_sap_code_qa_h2" runat="server" class="form-control" placeholder="자동생성" ReadOnly="True" /></td>
                                                        <td><asp:TextBox ID="txt_sys2_sap_code_qa" runat="server" class="form-control" placeholder="자동생성" ReadOnly="True" /></td>
                                                        <td><asp:TextBox ID="txt_sys2_sap_code_qa_h2" runat="server" class="form-control" placeholder="자동생성" ReadOnly="True" /></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><telerik:RadDateTimePicker ID="tp_sys1_expire_time_qa_h2" runat="server" TodayButtonVisibility="Visible" class="form-control" DateInput-DateFormat="yyyy-MM-dd HH:mm:ss" Style="width: 100%" /></td>
                                                        ...
                                                        <td><telerik:RadDateTimePicker ID="tp_sys2_expire_time_qa_h2" runat="server" TodayButtonVisibility="Visible" class="form-control" DateInput-DateFormat="yyyy-MM-dd HH:mm:ss" Style="width: 100%" /></td>
